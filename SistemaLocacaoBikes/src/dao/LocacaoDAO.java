...
public class LocacaoDAO {
    public void alugar(Locacao l){
        try (Connection con = ConnectionFactory.getConnection()){
            ...
            stmt.setTimestamp(3, new java.sql.Timestamp(l.getDataInicio().getTime()));
            stmt.setTimestamp(4, new java.sql.Timestamp(l.getDataFim().getTime()));
            stmt.executeUpdate();
            
            // Atualizar status da bicicletapara 'locada'
    ...
    public void devolver(int locacaoId, int bicicletaId){
        try (Connection con = ConnectionFactory.getConnection()){
            ...
            // Atualiza status da bicicleta para 'disponível'
